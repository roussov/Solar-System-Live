...
async function fetchPlanetStateVector(horizonsId, name) {
    ...
    const response = await axios_1.default.get(HORIZONS_URL, { params });
    ...
    (0, logger_1.logInfo)('horizons_fetch', { name, horizonsId, latencyMs });
    return {
        name,
        x_au: x,
        y_au: y,
